...
3800 LDA #<BONJOURM:LDY #>BONJOURM:JSR STROUT
3810 BONGET JSR GET:CMP #"{F8}":BEQ LESAVE
3820 CMP #"N":BNE BONGET:JMP READY
3830 ;
3840 LESAVE LDY #0:LDA SAVETBLE+1:STA TEMPJ:STY SAVETBLE+1
3850 LDA SAVETBLE+2:STA TEMPJ+1:STY SAVETBLE+2
3860 JSR SAVEEE2
3870 LDA TEMPJ:STA SAVETBLE+1
3880 LDA TEMPJ+1:STA SAVETBLE+2
3890 JMP DS
3900 ;
3910 ;
3920 ;
3930 RENTBLE .BYTE $8A,$9B,$CB,$A7,$8D,$89
3940 ;RUN,LIST,GO,THEN,GOSUB,GOTO
3950 RENMSGE1 .ASC " ** ILLEGAL LINE RANGE ** ":.BYTE 13,0
3960 BONJOURM .BYTE 13:.ASC " ? ".BYTE 13,O
3970 CONSTANT .BYTE $90,0,0,0,0
3980 .END 8,"W-64.E5"
3990 TOK64
4000 1.0)
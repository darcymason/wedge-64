...
4000 ;
4010 NAMESTR .ASC "{SPACE*8}":.BYTE 0
4020 ;
...
4270 .ASC " {-*10}{SPACE}":.BYTE 13,0
4280 ;
4290 STMSGE .ASC "{DOWN}MERGING LINE: "
4300 .BYTE 0
4310 CRIGHT .ASC "{RIGHT*14}"
4320 .BYTE 0
4330 ;
4340 USERSTRG .ASC ",8:":.BYTE0
4350 ;
4360 REVERSE .ASC "{REVERSE ON}{SPACE*20}{REVERSE OFF}"
4370 .BYTE 13,0
4380 COLTBLE .ASC "{BLACK}{WHITE}{RED}{CYAN}{156}{GREEN}{BLUE}{YELLOW}{ORANGE}{BROWN}{PINK}{DARK GRAY}{GRAY}{LIGHT GREEN}{LIGHT BLUE}{LIGHT GRAY}"
4390 ;

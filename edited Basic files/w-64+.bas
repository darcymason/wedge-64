...
1330 PRLINE LDY #1:LDA #" ":JSR PRINT
1340 STY $0F
1350 LDA (VARPTR),Y
1360 BEQ LAB1
1370 JSR $AAD7
...
2980 LDY VARSTART+1
2990 SAVEIT JSR SAVEPROG:LDA #13:JMP PRINT
3000 ;
3010 ;
...
3230 ;
3240 UPDATE TYA:CLC:ADC GETPTR:STA GETPTR:LDA GETPTR+1:ADC #0:STA GETPTR+1
3250 RTS

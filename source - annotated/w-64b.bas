...
575 ; XX is there a ROM routine to print +/- integer?
580 BPL PLUS
590 LDA #"-":JSR PRINT
...
1320 ; ====================================================
1330 PRLINE LDY #1:JSR SPACE; xx uncrunch!
1340 STY $0F
1350 LDA (VARPTR),Y
1360 BEQ LAB1
1370 JSR $AAD7
...
1900 ;
1908 ; ==== COLOUR (border, background, cursor) ===========
1909 ; XX Fix up
...
2730 INC MOVEFROM+1
2740 XXX INC MOVETO:BNE YYY; XX ?
2750 INC MOVETO+1
